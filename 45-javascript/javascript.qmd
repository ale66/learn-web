...
A JS variable is a symbolic name for some content, the *value,* that is kept in the browser's (volatile) memory

In spreadsheets, cells are variables

![](./imgs/quiz-data.png)

`B2 = 32` is a variable with name `B2`, content `32` and type `int`
