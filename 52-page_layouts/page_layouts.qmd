...
learned how to combine `HTML5+CSS` to obtain pleasing *static* pages.
...
Participate to the in-class project by developing content and styling one or more *articles* 