...
- creating pages in the way print shops create books

- can we take an arbitrary text and make it look good in print?
  
- boilerplates: a fixed structure with nested tags that is applied to provide conformity and readability
...
- Rename [rename-then-edit-me.html](./rename-then-edit-me.html) then open it with a browser

- Now open it with [VS Code], installed on your computer or online ([https://vscode.dev/](https://vscode.dev/)), or [Notepad++]() or a similar editor

- try out some change to the text, save the file then *reload* on the browser

- do the same with file [mystyle.css](./rename-then-edit-me.html)
...
Whatever the device (PC, laptop, tablet or smartphone) the page should take up the whole screen width 
